...
const LABEL_AMIGAVEL: Record<string, string> = {
  ...
  leads_meta:                "Leads — Meta Ads (Instagram/Facebook)",
  leads_google:              "Leads — Google Ads",
  leads_indicacao:           "Leads — Indicação",
  leads_organico:            "Leads — Orgânico (redes sociais)",
  leads_outros:              "Leads — Outras origens",
